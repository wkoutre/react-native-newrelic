...
var RNNewRelic = _reactNative.NativeModules.RNNewRelic;
var NewRelic = (function() {
  ...
  _createClass(NewRelic, [
    ...
    {
      key: "_overrideConsole",
      value: function _overrideConsole() {
        if (!__DEV__) {
    ...
    {
      key: "_reportUncaughtExceptions",
      value: function _reportUncaughtExceptions() {
        var _this = this;
        var errorUtils =
        ...
        errorUtils._globalHandler = function(error) {
          _this.send("JS:UncaughtException", {
            error: error,
    ...
    {
      key: "_reportRejectedPromises",
      value: function _reportRejectedPromises() {
        var _this2 = this;
    ...
    },
    {
      ...
      value: function setGlobalAttributes(args) {
    ...
    {
      key: "sendConsole",
      value: function sendConsole(type, args) {
    ...
    {
      key: "report",
      value: function report(eventName, args) {
        this.send(eventName, args);
      },
    },
    {
      key: "nativeLog",
      value: function nativeLog(log) {
